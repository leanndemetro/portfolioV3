                ...
                <div className="max-w-7xl mx-auto px-4 space-y-8 sm:px-6 lg:px-8">
                    <div className="text-base max-w-prose mx-auto lg:max-w-none">
                        ...
                        <p className="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">
                            How to setup the Alexa Skills Kit
                            <br></br>
                            Command Line Interface ASK CLI
                        </p>
                    </div>
                    ...
                    <div className="lg:grid lg:grid-cols-2 lg:gap-8 lg:items-start">
                        <div className="relative z-10">
                            <div className="prose prose-indigo text-gray-500 mx-auto lg:max-w-none">
                                ...
                                <ul role="list">
                                    <li><a href="https://nodejs.org/en/">Get Started with Node.js</a></li>
                                    <li><a href="https://git-scm.com/downloads">Get Started with Git</a></li>
                                    <li><a href="https://aws.amazon.com/">Create an AWS FREE TIER account</a></li>
                                    <li><a href="https://developer.amazon.com/">Create an Amazon Developer account</a></li>
                                </ul>
                                <p>
                    ...
                    <div className="prose prose-indigo text-gray-500 mx-auto lg:max-w-none z-10 relative">
                                <p>
                                ...
                                <p>
                                Now, you will need to navigate to the IAM account setup section of the developer.amazon.com documentation. This can be found <a href="https://developer.amazon.com/en-US/docs/alexa/smapi/manage-credentials-with-ask-cli.html#create-aws-credentials">here.</a>  Or copy the code below.
                                </p>
                                <code></code>
                                </div>
                </div>
