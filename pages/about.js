  ...
  <Nav />
        <div className="bg-black">
            <div className="mx-auto py-12 px-4 max-w-7xl sm:px-6 lg:px-8 lg:py-24">
                ...
                <div className="md:pt-6 pt-6 pb-0  md:grid md:grid-cols-3 gap-8 ">
                    <div className="space-y-5 md:col-span-2 sm:space-y-4">
                ...
                <p className="text-base text-white">
                    ...
                    <br></br>
                    <a className="pt-12 hover:italic text-2xl "target="__blank" href="https://alyssademetro-tutorials.vercel.app/">tutorials-alyssademetro.vercel.app</a>
                    </div>
                </div>
                </div>
                <div className="md:pt-16 pt-6 pb-0 md:pb-20 grid grid-cols-2 gap-8 ">
